$(function () {
    ...
    $("#addItemBtn").on("click", function (e) {
        ...
        const newItem = {
            ...
            Quantity: parseFloat($("#InvoiceItem_Quantity").val()),
            TotalValue: parseFloat($("#InvoiceItem_TotalValue").val()),
            ValueSalesExcludingST: parseFloat($("#InvoiceItem_ValueSalesExcludingST").val()),
            FixedNotifiedValueOrRetailPrice: parseFloat($("#InvoiceItem_FixedNotifiedValueOrRetailPrice").val()),
            SalesTaxApplicable: parseFloat($("#InvoiceItem_SalesTaxApplicable").val()),
            SalesTaxWithheldAtSource: parseFloat($("#InvoiceItem_SalesTaxWithheldAtSource").val()),
            ExtraTax: parseFloat($("#InvoiceItem_ExtraTax").val()),
            FurtherTax: parseFloat($("#InvoiceItem_FurtherTax").val()),
            SroScheduleNo: $("#InvoiceItem_SroScheduleNo").val(),
            FedPayable: parseFloat($("#InvoiceItem_FedPayable").val()),
            Discount: parseFloat($("#InvoiceItem_Discount").val()),
