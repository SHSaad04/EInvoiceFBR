        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalValues = table.Column<double>(type: "float", nullable: false),
                    ValueSalesExcludingST = table.Column<double>(type: "float", nullable: false),
                    FixedNotifiedValueOrRetailPrice = table.Column<double>(type: "float", nullable: false),
                    SalesTaxApplicable = table.Column<double>(type: "float", nullable: false),
                    SalesTaxWithheldAtSource = table.Column<double>(type: "float", nullable: false),
                    ExtraTax = table.Column<double>(type: "float", nullable: true),
                    FurtherTax = table.Column<double>(type: "float", nullable: true),
                    SroScheduleNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    FedPayable = table.Column<double>(type: "float", nullable: false),
